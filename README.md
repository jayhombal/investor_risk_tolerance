...
The project goal is to predict investor risk tolerance
...
Note: sometimes datasets can be quite large. If you want to store your data externally, we recommend symlinking your data directory (that is `investor_risk_tolerance/data`) to somewhere with more room.
